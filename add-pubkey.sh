...
#
# =============================================================
# HOW TO GENERATE YOUR SSH KEY (do this on your device first)
# =============================================================
#
# --- Mac / Linux ---
#   ssh-keygen -t ed25519 -f ~/.ssh/id_apollo -C "your-label"
#   cat ~/.ssh/id_apollo.pub
#   Copy the output and pass it to this script.
#
# --- Windows (PowerShell) ---
#   ssh-keygen -t ed25519 -f "$env:USERPROFILE\.ssh\id_apollo" -C "your-label"
#   Get-Content "$env:USERPROFILE\.ssh\id_apollo.pub"
#   Copy the output and pass it to this script.
#
